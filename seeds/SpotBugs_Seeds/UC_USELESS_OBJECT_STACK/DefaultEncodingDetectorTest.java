...
/**
 * Used by <code>DefaultEncodingDetectorTest</code> as sample code to test <code>
 * DefaultEncodingDetector</code>.
 *
 * <p>Methods containing deliberate encoding bugs are marked with <code>//@ExpectBug</code>.
 *
 * <p>If unexpected bugs are detected, or expected bugs are missing, <code>
 * DefaultEncodingDetectorTest</code> fails.
 */
public class DefaultEncodingDetectorTest {

  /**
   * Does not override the parent class's problematic method. Invocations of that method on
   * instances of this class should be flagged.
   */
  ...
  /**
   * Overrides the parent class's problematic method. Invocations of the overriding method should
   * NOT be flagged. However, direct calls to the superclass's problematic method via super should
   * be flagged.
   */
