...
/**
 * Test cases extracted from org.eclipse.jdt.core.tests.compiler.regression.NullReferenceTest,
 * version 1.39
 */
  ...
  static class Report171 {
    ...
    static class X {
      ...
      public Class foo(String name, boolean resolve) throws ClassNotFoundException {
        ...
        if (c == null) { // should complain: c can only be null
          File file = baz(name);
          if (file == null) throw new ClassNotFoundException();
        }
        return c;
      }
    }
  ...
  static class DoNotReport123 {
    static class X {
      public static final char[] replaceOnCopy(
          char[] array, char toBeReplaced, char replacementChar) {
