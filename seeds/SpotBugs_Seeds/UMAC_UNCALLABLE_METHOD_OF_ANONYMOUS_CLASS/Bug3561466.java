...
public class Bug3561466 {
  ...
  static class PrivateFunctions {
    ...
    public static Call<java.util.List<?>, java.util.List<java.lang.String>> calculateSymbolicValues(
      ...
      ReflectedCall<List<?>, List<String>> result =
          new ReflectedCall<java.util.List<?>, java.util.List<java.lang.String>>(
              "CalculateSymbolicValuesFunction", new Class[] {Metric.class}, domainLabelMetric);
      return result;
    }
  }
  ...
  void calculateSymbolicValues(
      final List<?> items,
      @CheckForNull final Metric<?, String> domainLabelMap,
      final SymbolAxisModel domainAxisModel) {
    Metric<?, String> labellingMetric = null;

    final CalculateSwingTask<List<String>> task =
        new CalculateSwingTask<List<String>>(
            items,
            PrivateFunctions.calculateSymbolicValues((Metric) labellingMetric),
