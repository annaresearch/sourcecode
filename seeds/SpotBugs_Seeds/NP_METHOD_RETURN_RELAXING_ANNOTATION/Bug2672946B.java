...
abstract class Bug2672946B extends Bug2672946A {
  ...
  /**
   * This method will inherit the @Nonnull annotation from Bug2672946A, rather than use the class
   * annotation @MethodsAreCheckNullByDefault. Thus, we do not expect a warning about relaxing an
   * annotation
   */
  ...
  public Bug2672946B getField() {
    ...
    if (field.hashCode() == 42) System.out.println("Found it");
  ...
  @ExpectWarning("NP")
  public Object foo() {
    if (bar().hashCode() == 17) return "x";
    return null;
  }

  @NoWarning("NP")
  public Object foo2() {
    if (getField().hashCode() == 17) return "x";
    return null;
  }

  @ExpectWarning("NP")
  public Object foo3() {
    if (bar2().hashCode() == 17) return "x";
    return null;
  }

  @ExpectWarning("NP")
  public Object foo4() {
    if (getField2().hashCode() == 17) return "x";
    return null;
  }
