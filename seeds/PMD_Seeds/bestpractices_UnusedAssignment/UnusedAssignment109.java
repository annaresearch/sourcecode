public class Sample {
  ...
  public ZonedDateTime sample(final String date, final ZonedDateTime paymentTimeStamp) {
    final ZonedDateTime startOfDayOnInceptionDate =
        zonedDateTimeAtOnePastMidnight(date, paymentTimeStamp.getZone());
    final ZonedDateTime startOfDayOnPaymentDate =
        zonedDateTimeAtOnePastMidnight(paymentTimeStamp.toLocalDate(), paymentTimeStamp.getZone());
  ...
  private ZonedDateTime zonedDateTimeAtOnePastMidnight(
