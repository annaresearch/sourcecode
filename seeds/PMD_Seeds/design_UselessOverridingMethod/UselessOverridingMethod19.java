...
class ExposingSerializer extends Serializer {
  ...
  /**
   * Overriding in order to change the access modifier from protected to public - so: not only
   * merely calling super.
   *
   * <p>Method signature in super class: protected void writeChild(nu.xom.Node arg0) throws
   * java.io.IOException;
   *
