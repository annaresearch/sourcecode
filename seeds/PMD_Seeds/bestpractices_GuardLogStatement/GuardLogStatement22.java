public class Logger {
  ...
  public void bar() {
    LOGGER.info(
        "Message with param: {}",
        expensiveOperation()); // bad, expensiveOperation is executed regardless
    LOGGER.info(
        "Message with param: %s",
        this.expensiveOperation()); // bad, expensiveOperation is executed regardless
