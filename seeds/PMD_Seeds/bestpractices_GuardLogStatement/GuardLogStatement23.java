public class Logger {
  ...
  public void case1() {
    LOGGER.debug(
        "log something"
            + " and "
            + "concat strings"); // the same as "log something and concat strings"
  }
  ...
  public void case2() {
    ...
    LOGGER.debug(
        constantPrefix
            + " and "
            + constantSuffix); // the same as "log something and concat strings"
  }
  ...
  public void case4() {
    LOGGER.debug(
        "Some long string that has been " + "separated into two constants. Contains value: {}",
        param);
  }
