...
class WildcardReturnParameterTypeCheck {
  ...
  class Dog extends Animal {
    ...
    public List<? extends Class<String>>
        bar() { // Noncompliant {{Remove usage of generic wildcard type.}}
      return null;
    }
  ...
  public Collector<Integer, ?, Integer>
      getCollector() { // Compliant Collector second argument is ignored, second parameter is an
