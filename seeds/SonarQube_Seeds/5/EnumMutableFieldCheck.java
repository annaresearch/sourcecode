...
enum Continent {
  ...
  public void setLandMass1(
      int landMass) { // Noncompliant [[sc=3;ec=9]] {{Lower the visibility of this setter or remove
    // it altogether.}}
    this.landMass = landMass;
  }

  public void setLandMass2(
      int landMass) { // compliant: empty setter is harmless : this can be a pattern used when
    // implementing singleton enums.
  }
...
enum Continent2 {
  ...
  private int landMass;
  public final java.util.List regions =
      null; // Noncompliant {{Lower the visibility of this field.}}
