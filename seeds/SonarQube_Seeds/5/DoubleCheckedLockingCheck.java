...
class DoubleCheckedLockingCheck {
  ...
  public Helper classicCase() {
    if (helper == null)
      synchronized (
          this) { // Noncompliant [[sc=7;ec=19;secondary=6,8]] {{Remove this dangerous instance of
  ...
  public Helper memberSelectCondition() {
    if (this.helper == null)
      synchronized (
          this) { // Noncompliant [[sc=7;ec=19;secondary=25,27]] {{Remove this dangerous instance of
        // double-checked locking.}}
        if (helper == null) this.helper = new Helper();
      }
    return helper;
  }
  ...
  public Helper memberSelectCondition2() {
    if (helper == null)
      synchronized (
          this) { // Noncompliant [[sc=7;ec=19;secondary=34,36]] {{Remove this dangerous instance of
        // double-checked locking.}}
  ...
  public Helper memberSelectCondition3() {
    if (this.helper == null)
      synchronized (
          this) { // Noncompliant [[sc=7;ec=19;secondary=43,45]] {{Remove this dangerous instance of
        // double-checked locking.}}
        if (this.helper == null) this.helper = new Helper();
      }
    return helper;
  ...
  public Helper invertedConditions() {
    if (null == this.helper)
      synchronized (
          this) { // Noncompliant [[sc=7;ec=19;secondary=52,54]] {{Remove this dangerous instance of
        // double-checked locking.}}
        if (null == helper) this.helper = new Helper();
      }
    return helper;
  }
  ...
  public Helper intializationViaMemberSelect2() {
    if (helper == null)
      synchronized (
          this) { // Noncompliant [[sc=7;ec=19;secondary=61,63]] {{Remove this dangerous instance of
        // double-checked locking.}}
        if (helper == null) this.helper = new Helper();
      }
    return helper;
  ...
  public HelperInterface interfaceHelper() {
    if (helperInterface == null)
      synchronized (
          this) { // Noncompliant [[sc=7;ec=19;secondary=73,75]] {{Remove this dangerous instance of
        // double-checked locking.}}
        if (helperInterface == null) this.helperInterface = new Helper();
      }
  ...
  public AbstractHelper abstractHelper() {
    if (abstractHelper == null)
      synchronized (
          this) { // Noncompliant [[sc=7;ec=19;secondary=82,84]] {{Remove this dangerous instance of
        // double-checked locking.}}
        if (abstractHelper == null) this.abstractHelper = new Helper();
      }
    return abstractHelper;
  }

  static class Helper extends AbstractHelper implements HelperInterface {
    int field;
  }
...
class DoubleCheckedLockingCheckNestedIfs {
  ...
  public Helper unrelatedNestedIfs() {
    if (null == helper) {
      ...
      synchronized (
          this) { // Noncompliant [[sc=7;ec=19;secondary=116,123]] {{Remove this dangerous instance
        // of double-checked locking.}}
        if (sunIsDown) {
          doSomethingElse();
          if (null == helper) helper = new Helper();
        }
      }
    }
    return helper;
...
class DoubleCheckedLockingCheckCompliant {
  ...
  public Helper synchronizedWithTwoIfs() {
    synchronized (this) { // Compliant
      if (helper == null) if (helper == null) helper = new Helper();
    }
    return helper;
  }
