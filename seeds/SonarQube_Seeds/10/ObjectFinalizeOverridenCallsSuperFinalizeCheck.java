...
class S1114_Case_2 extends S1114_Class3 {
  ...
  protected void finalize() throws Throwable {
    super.finalize(); // Noncompliant [[sc=5;ec=21]] {{Move this super.finalize() call to the end of
    // this Object.finalize() implementation.}}
    System.out.println("foo");
  }
}
...
class S1114_Case_3 extends S1114_Class3 {
  ...
  protected void finalize()
      throws
          Throwable { // Noncompliant [[sc=18;ec=26]] {{Add a call to super.finalize() at the end of
    // this Object.finalize() implementation.}}
...
class S1114_Case_4 extends S1114_Class3 {
  @Override
  protected void finalize()
      throws Throwable { // Noncompliant {{Add a call to super.finalize() at the end of this
    // Object.finalize() implementation.}}
