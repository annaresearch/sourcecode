...
class CallGetClassCheck_A {
  ...
  void foo() {
    ...
    new CallGetClassCheck_B().getClass(); // Noncompliant {{Remove this object instantiation and use
    ...
    new CallGetClassCheck_C().getClass(); // Noncompliant {{Remove this object instantiation and use
    ...
    new CallGetClassCheck_F().getClass(); // Noncompliant {{Remove this object instantiation and use
