...
class NullShouldNotBeUsedWithOptionalCheck_jdkClassA {
  ...
  public void NonnullWithArgument1() {
    @javax.annotation.Nonnull(
        when = When.MAYBE) // Noncompliant [[sc=5;ec=48]] {{"Optional" variables should not be
    // "@Nonnull(when=MAYBE)".}}
    Optional<String> var;
  }
  ...
  public void NonnullWithArgument2() {
    @javax.annotation.Nonnull(
        when = When.NEVER) // Noncompliant [[sc=5;ec=48]] {{"Optional" variables should not be
    // "@Nonnull(when=NEVER)".}}
    Optional<String> var;
  }
  ...
  public void NonnullWithArgument3() {
    @javax.annotation.Nonnull(
        when = When.UNKNOWN) // Noncompliant [[sc=5;ec=50]] {{"Optional" variables should not be
