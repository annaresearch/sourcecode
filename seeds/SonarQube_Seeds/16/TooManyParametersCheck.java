...
public class TooManyParametersCheck {
  TooManyParametersCheck(
      ...
      int p6,
      int p7,
      int p8) { // Noncompliant {{Constructor has 8 parameters, which is greater than 7
    // authorized.}}
  }
  ...
  void method(
      ...
      int p6,
      int p7,
      int p8) { // Noncompliant [[sc=8;ec=14]] {{Method has 8 parameters, which is greater than 7
    // authorized.}}
  }
  ...
  static void staticMethod(
      int p1, int p2, int p3, int p4, int p5, int p6, int p7, int p8) {} // Noncompliant
}
