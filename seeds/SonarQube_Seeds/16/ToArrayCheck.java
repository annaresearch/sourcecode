...
class ToArrayCheck<T> {
  <E extends T> Object[] foo(
      List<String> listOfString, List<String> listOfNumber, Set rawSet, Collection<E> col) {
    String[] a1 =
        (String[])
            listOfString
                .toArray(); // Noncompliant [[sc=30;ec=52;quickfixes=qf1]] {{Pass "new String[0]" as
    // argument to "toArray".}}
    ...
    Number[] a21 =
        (Number[])
            listOfNumber
                .toArray(); // Noncompliant [[sc=37;ec=59;quickfixes=qf2]] {{Pass "new Number[0]" as
    // argument to "toArray".}}
    ...
    Number[] a22 =
        (Number[])
            rawSet
                .toArray(); // Noncompliant [[sc=31;ec=47;quickfixes=qf3]] {{Pass "new Number[0]" as
    // argument to "toArray".}}
    ...
    Number[] a23 =
        (Number[])
            col.toArray(); // Noncompliant [[sc=31;ec=44;quickfixes=qf4]] {{Pass "new Number[0]" as
    // argument to "toArray".}}
