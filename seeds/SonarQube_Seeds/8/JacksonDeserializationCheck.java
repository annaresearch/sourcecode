...
class JacksonDeserializationCheck {
  ...
  public void enableDefaultTyping() {
    ...
    mapper.enableDefaultTyping(); // Noncompliant [[sc=5;ec=33]] {{Make sure using this Jackson
    // deserialization configuration is safe here.}}
  }
}
...
@JsonTypeInfo(
    use =
        JsonTypeInfo.Id
            .CLASS) // Noncompliant [[sc=21;ec=42]] {{Make sure using this Jackson deserialization
// configuration is safe here.}}
abstract class JacksonDeserializationPhoneNumber {

  @JsonTypeInfo(
      use =
          JsonTypeInfo.Id
              .CLASS) // Noncompliant {{Make sure using this Jackson deserialization configuration
  // is safe here.}}
  String field;
}
...
class JacksonDeserializationJacksonCodehaus {
  ...
  @org.codehaus.jackson.annotate.JsonTypeInfo(
      use = org.codehaus.jackson.annotate.JsonTypeInfo.Id.CLASS) // Noncompliant
  abstract class PhoneNumber {}

  @org.codehaus.jackson.annotate.JsonTypeInfo(
      use = org.codehaus.jackson.annotate.JsonTypeInfo.Id.MINIMAL_CLASS) // Noncompliant
