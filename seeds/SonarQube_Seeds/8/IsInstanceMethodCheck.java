...
public class IsInstanceMethodCheck {
  int noncompliant1(Object o) {
    if (String.class.isInstance(
        o)) { // Noncompliant [[sc=9;ec=35]]{{Replace this usage of "String.class.isInstance()" with
      // "instanceof String".}}
      return 42;
    }
    return 0;
  ...
  boolean compliant3(Object o, String c) throws ClassNotFoundException {
    ...
    int[]
        .class.isInstance(
            o); // Noncompliant {{Replace this usage of "int[].class.isInstance()" with "instanceof
    // int[]".}}
    int[][]
        .class.isInstance(
            o); // Noncompliant {{Replace this usage of "int[][].class.isInstance()" with
    // "instanceof int[][]".}}
    int[][][]
        .class.isInstance(
            o); // Noncompliant {{Replace this usage of "int[][][].class.isInstance()" with
    ...
    checks.Utility.class.isInstance(
        0); // Noncompliant {{Replace this usage of "Utility.class.isInstance()" with "instanceof
    // Utility".}}
