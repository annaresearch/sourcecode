  ...
  void foo() {
    ...
    try {
      ...
      logger.log(e);
        ...
        SQLException
            e) { // Noncompliant [[sc=12;ec=26;secondary=12]] {{Combine this catch with the one at
      // line 12, which has the same body.}}
      doCleanup();
      logger.log(e);
      ...
      throw e;
        ...
        ArrayStoreException
            e) { // Noncompliant [[sc=11;ec=32;secondary=12]] {{Combine this catch with the one at
      // line 12, which has the same body.}}
      doCleanup();
      logger.log(e);
    }
    ...
    try {
      ...
      logger.log(e);
        ...
        SQLException
            e) { // Noncompliant [[sc=12;ec=26;secondary=31]] {{Combine this catch with the one at
      // line 31, which has the same body.}}
      doCleanup();
      logger.log(e);
