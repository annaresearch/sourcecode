...
/**
 * No detection of commented-out code in Javadoc for class for (Visitor visitor : visitors) {
 * continue; }
 */
public class CommentedCode {

  /**
   * No detection of commented-out code in Javadoc for field for (Visitor visitor : visitors) {
   * continue; }
   */
  private int field;

  /**
   * No detection of commented-out code in Javadoc for constructor for (Visitor visitor : visitors)
   * { continue; }
   */
  public CommentedCode(int field) {
    ...
    */
    ...
    if (
    /* for (Visitor visitor : visitors) { } */ field == 0) {
      /* for (Visitor visitor : visitors) { } */
    }
    ...
    */
    ...
    // TODO
    /**
     * This is not Javadoc, even if it looks like Javadoc and before declaration of variable for
     * (Visitor visitor : visitors) { continue; }
     */
    int a;
  }
  ...
  // TODo
  /**
   * From GWT documentation: JSNI methods are declared native and contain JavaScript code in a
   * specially formatted comment block between the end of the parameter list and the trailing
   * semicolon.
   */
  ...
  /**
   * No detection of commented-out code in Javadoc for method for (Visitor visitor : visitors) {
   * continue; }
   */
  public int getField() {
    return field;
   ...
   */
  public void foo() {
    // FIXME: the following line calls {@link CommentedCode#method(String)} - javadoc links are
    // accepted in comments
    method("");
  }
  // C++
}
