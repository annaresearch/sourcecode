...
class S1874_CallToDeprecatedMethod {
  ...
  public S1874_CallToDeprecatedMethod() {
    ...
    string.getBytes(
        ...
        1,
        new byte[3],
        7); // Noncompliant [[sc=12;ec=20]] {{Remove this use of "getBytes"; it is deprecated.}}
    new DeprecatedConstructor(); // Noncompliant [[sc=9;ec=30]] {{Remove this use of
    // "DeprecatedConstructor"; it is deprecated.}}
  ...
  public static class ExtendsDeprecatedClass
      extends MyDeprecatedClass { // Noncompliant [[sc=54;ec=71]] {{Remove this use of
    // "MyDeprecatedClass"; it is deprecated.}}
  }

  public abstract static class ClassWithDeprecatedMethods {
    @Deprecated
  ...
  public static class ClassOverridingDeprecatedMethods extends ClassWithDeprecatedMethods
      implements InterfaceWithDeprecatedMethods {
    public void
        deprecatedMethod1() { // Noncompliant [[sc=17;ec=34]] {{Don't override a deprecated method
...
class MyCustomClass {
  @Deprecated MyDeprecatedType myVar;
}
...
class MethodResolution {
  public static void test() {
    ...
    HasDeprecations.method(
        new HashMap<>()); // Noncompliant [[sc=21;ec=27]] {{Remove this use of "method"; it is
    // deprecated.}}
  }
