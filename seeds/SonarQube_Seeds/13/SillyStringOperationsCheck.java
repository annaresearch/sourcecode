...
class SillyStringOperationsCheck {
  void f(String str, String other, int from, int to) {
    ...
    ""
        .compareToIgnoreCase(
            ""); // Noncompliant {{Remove this "compareToIgnoreCase" call; it has predictable
    // results.}}
    ...
    ""
        .indexOf(
            "", from); // Noncompliant {{Remove this "indexOf" call; it has predictable results.}}
    ...
    ""
        .lastIndexOf(
            ""); // Noncompliant {{Remove this "lastIndexOf" call; it has predictable results.}}
    ...
    ""
        .lastIndexOf(
            "",
            from); // Noncompliant {{Remove this "lastIndexOf" call; it has predictable results.}}
    ...
    ""
        .startsWith(
            ""); // Noncompliant {{Remove this "startsWith" call; it has predictable results.}}
    ...
    ""
        .replaceFirst(
            "",
            "str"); // Noncompliant {{Remove this "replaceFirst" call; it has predictable results.}}
    ...
    str.substring(
        0,
        str.length()); // Noncompliant {{Remove this "substring" call; it has predictable results.}}
