...
class StaticMemberAccessQuickFixes {
  ...
  static class InnerClass extends StaticMemberAccessQuickFixes {
    ...
    void bar() {
      InnerClass.counter++; // Noncompliant [[sc=18;ec=25;quickfixes=qf1]] {{Use static access with
      // "checks.StaticMemberAccessQuickFixes" for "counter".}}
  ...
  static class SecondInnerClass extends InnerClass {
    void qix() {
      SecondInnerClass
          .otherCounter++; // Noncompliant [[sc=24;ec=36;quickfixes=qf2]] {{Use static access with
      // "checks.StaticMemberAccessQuickFixes$InnerClass" for "otherCounter".}}
...
class StaticMemberAccessQuickFixesChild extends StaticMemberAccessQuickFixes {
  void bar() {
    StaticMemberAccessQuickFixesChild
        .counter++; // Noncompliant [[sc=39;ec=46;quickfixes=qf3]] {{Use static access with
    // "checks.StaticMemberAccessQuickFixes" for "counter".}}
    ...
    StaticMemberAccessQuickFixesChild
        .foo(); // Noncompliant [[sc=39;ec=42;quickfixes=qf4]] {{Use static access with
    // "checks.StaticMemberAccessQuickFixes" for "foo".}}
