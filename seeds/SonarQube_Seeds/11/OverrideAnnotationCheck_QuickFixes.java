...
public class OverrideAnnotationCheck_QuickFixes extends OverrideAnnotationCheckSimple {
  ...
  abstract static class AbstractClass {
    ...
    static class ExtendsAbstractClass extends AbstractClass {
      boolean foo() {
        return false;
      } // Compliant - overridee is abstract

      @Deprecated
      public boolean bar() {
        return true;
      } // Noncompliant [[sc=22;ec=25;quickfixes=qf2]]
  ...
  abstract class ImplementsFromJDK8 implements java.lang.reflect.AnnotatedElement {
    ...
    public <A extends java.lang.annotation.Annotation> A[] getAnnotationsByType(
      ...
      return null;
    } // Noncompliant [[sc=60;ec=80;quickfixes=qf3]]
  ...
  @OtherAnnotation
  public @Annotation synchronized void get() {} // Noncompliant [[sc=57;ec=60;quickfixes=qf4]]
  // fix@qf4 {{Add "@Override" annotation}}
  // edit@qf4 [[sc=3;ec=3]] {{@Override\n  }}

  static class InnerClassSingleLine extends OverrideAnnotationCheckSimple {
    public void get() {}
  } // Noncompliant [[sc=89;ec=92;quickfixes=qf5]]
...
class AbstractOverrideAnnotationSingleLine extends OverrideAnnotationCheckSimple {
  public void get() {}
} // Noncompliant [[sc=96;ec=99;quickfixes=qf6]]
