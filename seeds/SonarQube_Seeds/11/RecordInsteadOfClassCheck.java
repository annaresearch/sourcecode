...
public class RecordInsteadOfClassCheck {
  class SimpleClass
      implements NotAClass { // Noncompliant [[sc=9;ec=20]] {{Refactor this class declaration to use
                             // 'record SimpleClass(int sum)'.}}
  ...
  class SimpleClass2 { // Noncompliant [[sc=9;ec=21]] {{Refactor this class declaration to use
                       // 'record SimpleClass2(boolean boom, int a)'.}}
    private final boolean boom;
    private final int a;

    SimpleClass2(boolean boom, int a) {
      this.boom = boom;
      this.a = a;
    }
  ...
  class ComplexClass { // Noncompliant {{Refactor this class declaration to use 'record
                       // ComplexClass(int sum, List<...> list, boolean[][] tests, boo...)'.}}
    private final int sum;
  ...
  class SimpleWithoutGettersForAllFields {
    ...
    SimpleWithoutGettersForAllFields(int sum, int base) {
      this.sum = sum;
      this.base = base;
    }
  ...
  class SimpleWithConstructorNotSettingAllParameters {
    ...
    SimpleWithConstructorNotSettingAllParameters(int sum) {
      this.sum = sum;
      base = 42;
    }
  ...
  class SimpleWithConstructorNotSettingAllParameters2 {
    ...
    SimpleWithConstructorNotSettingAllParameters2(int sum, String other) {
      this.sum = sum;
      base = 42;
    }
  ...
  class ClassWithNoRealSetter { // Noncompliant {{Refactor this class declaration to use 'record
                                // ClassWithNoRealSetter(int sum)'.}}
    private final int sum;
  ...
  class ClassWithNoRealGetter {
    ...
    ClassWithNoRealGetter(int sum) {
      this.sum = sum;
    }

    int getSum(int expected) {
      return sum;
    }
  }
  ...
  class ClassExtendingClass extends SimpleClass {
    ClassExtendingClass() {
      super(0);
    }
  }
  ...
  class ClassWithPrivateNonFinalField {
    private int base;
  }

  class ClassWithPublicFinalField {
    public final int base = 0;
  }

  class ClassWithoutFields {}

  class ClassWithoutFinalFields {
    private int sum;
  }
  ...
  class GetterWithOtherReturnType { // Compliant, getter does not have the same return type as the
                                    // default one in record
  ...
  // When the constructor has smaller visibility, it is not possible to create a record with the
  // same behavior.
  ...
  public
  class ClassWithProtectedConstructor { // Compliant, constructor visibility is smaller than public
    private final int sum;
  ...
  public
  class ClassWithPackagePrivateConstructor { // Compliant, constructor visibility is smaller than
                                             // public
    private final int sum;
  ...
  public
  class ClassWithPrivateConstructor { // Compliant, constructor visibility is smaller than public
    private final int sum;
