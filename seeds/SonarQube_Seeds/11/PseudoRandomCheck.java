...
class PseudoRandomCheck {
  void fun() {
    ...
    // java.util.Random
    Random random =
        new Random(); // Noncompliant [[sc=25;ec=31]] {{Make sure that using this pseudorandom
    // number generator is safe here.}}
    ...
    rand9 =
        RandomStringUtils.random(
            1, 0, 0, false, false, null, new Random()); // Noncompliant [[sc=71;ec=77]]
    // Here there should be no issue because `random` will use the supplied secure source of
    // randomness
    rand9 = RandomStringUtils.random(1, 0, 0, false, false, null, new SecureRandom()); // Compliant

    // org.apache.commons.lang3.RandomStringUtils
    org.apache.commons.lang3.RandomStringUtils randomStringUtils2 =
        new org.apache.commons.lang3.RandomStringUtils();
    ...
    rand11 =
        org.apache.commons.lang3.RandomStringUtils.random(
            1, 0, 0, false, false, null); // Noncompliant [[sc=57;ec=63]]
    // Here we should raise an issue only on the `new Random`, not on the call to `random` itself
    rand11 =
        org.apache.commons.lang3.RandomStringUtils.random(
            1, 0, 0, false, false, null, new Random()); // Noncompliant [[sc=97;ec=103]]
    // Here there should be no issue because `random` will use the supplied secure source of
    // randomness
    rand11 =
        org.apache.commons.lang3.RandomStringUtils.random(
            1, 0, 0, false, false, null, new SecureRandom()); // Compliant
