...
public class RawTypeCheck {
  ...
  void foo() {
    GenericClass
        v; // Noncompliant [[sc=5;ec=17]] {{Provide the parametrized type for this generic.}}
    v = new GenericClass(); // Noncompliant [[sc=13;ec=25]] {{Provide the parametrized type for this
    // generic.}}
  ...
  abstract static class InnerClass1
      extends GenericClass { // Noncompliant [[sc=45;ec=57]] {{Provide the parametrized type for
    // this generic.}}
  ...
  static class InnerClass2 extends InnerClass1 {
    ...
    @Override
    void qix(GenericClass gc) {} // Compliant - override
  }

  static class InnerClass3
      implements GenericInterface {} // Noncompliant [[sc=39;ec=55]] {{Provide the parametrized type
  // for this generic.}}

  static class InnerClass4
      implements GenericInterface<GenericClass> {} // Noncompliant [[sc=56;ec=68]]
