...
class RandomFloatToIntCheck {
  ...
  // java.lang.Math
  int rand6 =
      (int) Math.random() * 50; // Noncompliant {{Use "java.util.Random.nextInt()" instead.}}
  int rand7 =
      (int)
          new RandomFloatToIntCheckFoo() {
            int foo() {
  ...
  int rand8 =
      (int) ThreadLocalRandom.current().nextDouble()
          * 50; // Noncompliant {{Use "nextInt()" instead.}}
  ...
  int rand21 =
      (int) org.apache.commons.lang3.RandomUtils.nextDouble()
          * 50; // Noncompliant {{Use "nextInt()" instead.}}
  ...
  int rand25 =
      (int) org.apache.commons.lang3.RandomUtils.nextFloat(); // Noncompliant; will always be 0;
}
