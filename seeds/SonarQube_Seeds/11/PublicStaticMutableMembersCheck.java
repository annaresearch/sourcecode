...
public class PublicStaticMutableMembersCheck {
  public static String[] strings1 = {
    "first", "second"
  }; // Noncompliant [[sc=27;ec=35]] {{Make this member "protected".}}
  ...
  public static final int[][] NON_EMPTY_DATA_2 = {
    new int[0], {}
  }; // Noncompliant - you can still modify sub array
  ...
  public static final List<Object> SINGLETON_UNMODIFIABLE_LIST =
      Collections.singletonList(new Object());
  public static final Map<Object, Object> SINGLETON_UNMODIFIABLE_MAP =
  ...
  public static final List<String> immutableListApacheNew =
      new org.apache.commons.collections4.list.UnmodifiableList(new ArrayList<>());
  public static final List<String> immutableListApache =
      org.apache.commons.collections4.list.UnmodifiableList.unmodifiableList(
          new ArrayList<String>());
  public static final Set<String> immutableSetApache =
      org.apache.commons.collections4.set.UnmodifiableSet.unmodifiableSet(new HashSet<String>());
  public static final Map<String, String> immutableMapApache =
      org.apache.commons.collections4.map.UnmodifiableMap.unmodifiableMap(
  ...
  public void changeEmptyList() {
    ...
    PublicStaticMutableMembersCheck.otherEmptyList =
        new ArrayList(); // Noncompliant {{Make member "otherEmptyList" "protected".}}
  }
  ...
  public static final Set<E> set = Collections.unmodifiableSet(EnumSet.of(E.A, E.C));
...
interface PublicStaticMutableMembersCheck_I {
  public static String[] MY_ARRAY =
      null; // Noncompliant {{Move "MY_ARRAY" to a class and lower its visibility}}
  public static Collection<String> MY_COLLECTION =
      null; // Noncompliant {{Move "MY_COLLECTION" to a class and lower its visibility}}
  public static Collection MY_2ND_COLLECTION =
      null; // Noncompliant {{Move "MY_2ND_COLLECTION" to a class and lower its visibility}}
  public static List<String> MY_LIST =
      null; // Noncompliant {{Move "MY_LIST" to a class and lower its visibility}}
  public static List MY_2ND_LIST =
      null; // Noncompliant {{Move "MY_2ND_LIST" to a class and lower its visibility}}
  public static Date MY_DATE =
      null; // Noncompliant {{Move "MY_DATE" to a class and lower its visibility}}
