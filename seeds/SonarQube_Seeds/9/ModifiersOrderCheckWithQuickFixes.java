...
class ModifiersOrderCheckWithQuickFixes {
  ...
  private static final int A = 0, B = 1; // Noncompliant [[sc=17;ec=23;quickfixes=qf1]]
  // fix@qf1 {{Reorder modifiers}}
  // edit@qf1 [[sc=3;ec=23]] {{}}
  // edit@qf1 [[sc=3;ec=3]] {{private static final}}

  public static void otherMain(String[] args) {} // Noncompliant [[sc=10;ec=16;quickfixes=qf2]]
  ...
  final @Annotation2 static void foo() {}
  ...
  public final native @Annotation2 static synchronized void bar();
  ...
  static @Annotation2 void
      qix() {} // Compliant - Annotation is not counted as part of the modifier, but attached to the
  // type "void"

  public @Annotation2
  ModifiersOrderCheckWithQuickFixes() {} // Compliant - Annotation is not counted as part of the
  // modifier, even for constructors
  ...
  static final @Annotation2 class Inner {} // Noncompliant [[sc=9;ec=15;quickfixes=qf5]]
  ...
  @Annotation2
  static final class Inner2 {} // Noncompliant [[sc=9;ec=15;quickfixes=qf6]]
