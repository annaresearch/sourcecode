...
class HardcodedURICheck {
  ...
  void foo(String s, String var) throws URISyntaxException {
    ...
    new File("", s); // Compliant
    new File(
        "", s + "/" + s); // Noncompliant [[sc=22;ec=25]] {{Remove this hard-coded path-delimiter.}}

    new URI("http:https"); // Compliant
    new URI("http://www.mywebsite.com"); // Noncompliant [[sc=13;ec=39]] {{Refactor your code to get
    // this URI from a customizable parameter.}}
    new File(
        "/home/path/to/my/file.txt"); // Noncompliant [[sc=14;ec=41]] {{Refactor your code to get
    // this URI from a customizable parameter.}}
    new File(
        s,
        "~\\blah\\blah\\blah.txt"); // Noncompliant [[sc=17;ec=42]] {{Refactor your code to get this
    // URI from a customizable parameter.}}
    new File(
        "/Folder/",
        s); // Noncompliant [[sc=14;ec=24]] {{Refactor your code to get this URI from a customizable
    // parameter.}}

    String filename;
    String path =
        "/home/path/to/my/file.txt"; // Noncompliant [[sc=19;ec=46]] {{Refactor your code to get
    // this URI from a customizable parameter.}}
    String fileName =
        "\\\\blah\\blah\\"; // Noncompliant {{Refactor your code to get this URI from a customizable
    // parameter.}}
    String fileNAME = s; // Compliant
    String stuff =
        "/home/path/to/my/file.txt"; // Compliant  - requires a variable with adequate name
