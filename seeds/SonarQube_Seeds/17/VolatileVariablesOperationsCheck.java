...
class VolatileVariablesOperationsCheck {
  ...
  public void incrementCounts() {
    ...
    ++this.count1; // Noncompliant {{Use an "AtomicInteger" for this field; its operations are
    // atomic.}}
    (count2)++; // Noncompliant {{Use an "AtomicLong" for this field; its operations are atomic.}}
    count2 = (++count2); // Noncompliant {{Use an "AtomicLong" for this field; its operations are
    // atomic.}}
