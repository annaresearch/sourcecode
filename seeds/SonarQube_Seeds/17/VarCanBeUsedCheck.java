...
public class VarCanBeUsedCheck {
  ...
  void f(int[] array) {
    ...
    String s1 =
        new String("ABC"); // Noncompliant [[sc=12;ec=14]] {{Declare this local variable with "var"
    // instead.}}
    ...
    char c =
        i == 3
            ? 0
            : "hdr".charAt(i); // Compliant, despite it's possible here, ternary  operator may bring
