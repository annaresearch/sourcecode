...
public class UnusedPrivateClass {
  ...
  private
  class Unused {} // Noncompliant {{Remove this unused private "Unused" class.}} [[sc=17;ec=23]]
  ...
  private enum MyUsedEnum {
    QIX,
    PLOP;
  }

  private @interface
  AnnotationUnused {} // Noncompliant {{Remove this unused private "AnnotationUnused" class.}}
  // [[sc=22;ec=38]]
