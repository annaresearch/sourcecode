...
class DiamondOperatorCheck_java_7 {
  ...
  List<Object> myList2 =
      new ArrayList<
          Object>(); // Noncompliant [[sc=39;ec=47]] {{Replace the type specification in this
  ...
  void foo() {
    ...
    new DiamondOperatorCheck_java_7().myList1 =
        new ArrayList<Object>(); // Noncompliant [[sc=62;ec=70]]
