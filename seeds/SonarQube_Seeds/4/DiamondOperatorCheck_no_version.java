...
class DiamonOperatorCheck_no_version {
  ...
  List<Object> myList2 =
      new ArrayList<
          Object>(); // Noncompliant [[sc=39;ec=47;quickfixes=qf1]] {{Replace the type specification
  ...
  List<Object> myList3 =
      new ArrayList< // Noncompliant [[sc=39;el=+2;ec=6;quickfixes=qf2]]
          Object>();
  ...
  void foo() {
    ...
    Map<String, List<Integer>> map2 =
        new HashMap<String, List<Integer>>(); // Noncompliant [[sc=49;ec=71]]

    List myOtherList = new ArrayList<Object>(); // Compliant
    new DiamonOperatorCheck_no_version().myList1 = new ArrayList<>(); // Compliant
    new DiamonOperatorCheck_no_version().myList1 =
        new ArrayList<Object>(); // Noncompliant [[sc=65;ec=73]]
    ...
    Iterator<Object> iterator =
        new Iterator<Object>() { // Compliant - anonymous classes requires to be typed
          @Override
          public Object next() {
            return null;
          }
