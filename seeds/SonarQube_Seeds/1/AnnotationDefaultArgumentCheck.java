...
class AnnotationDefaultArgumentCheck {
  ...
  @MyAnnotationDefaultCheck(
      myName = "myName",
      myInteger =
          2) // Noncompliant [[sc=29;ec=44]] {{Remove this default value assigned to parameter
  // "myName".}}
  @MyAnnotationDefaultCheck2("defaultValue") // Noncompliant
  @MyAnnotationDefaultCheck3(
      myHexaInteger = 0x000) // Noncompliant {{Remove this default value assigned to parameter
  // "myHexaInteger".}}
  void m1() {}
  ...
  @MyAnnotationDefaultCheck(
      myName = "foo",
      myInteger =
          0) // Noncompliant [[sc=43;ec=54]] {{Remove this default value assigned to parameter
  // "myInteger".}}
  ...
  @MyAnnotationDefaultCheck(
      myName = "foo",
      myInteger = FIELD_VALUE_INT) // Noncompliant {{Remove this default value assigned to parameter
  // "myInteger".}}
  void m4() {}
