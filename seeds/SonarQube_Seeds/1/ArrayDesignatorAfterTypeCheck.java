...
class ArrayDesignatorAfterTypeCheck {

  public int getVector()[] {
    return new int[0];
  } // Noncompliant [[sc=25;ec=27;quickfixes=qf1]] {{Move the array designators [] to the end of the
  // return type.}}
  ...
  public int[][] getMatrixCompliant() {
    return new int[0][];
  } // Compliant

  public int foo()[][][][] {
    return new int[0][][][];
  } // Noncompliant[[sc=19;ec=27;quickfixes=qf3]] {{Move the array designators [][][][] to the end
  // of the return type.}}
