...
public class RedundantThrowsDeclarationCheck {
  ...
  public void foo8()
      throws MyException,
          Exception { // Noncompliant [[sc=29;ec=40;quickfixes=qf_first]] {{Remove the declaration
    // of thrown exception 'checks.RedundantThrowsDeclarationCheck$MyException'
  ...
  public void foo9()
      throws Error,
          Throwable { // Noncompliant {{Remove the declaration of thrown exception 'java.lang.Error'
    // which is a subclass of 'java.lang.Throwable'.}}
  }

  public void foo11() throws MyException, MyException { // Noncompliant {{Remove the redundant
    // 'checks.RedundantThrowsDeclarationCheck$MyException' thrown exception
    // declaration(s).}}
  }

  public void foo12()
      throws MyException, MyException,
          Throwable { // Noncompliant {{Remove the declaration of thrown exception
    // 'checks.RedundantThrowsDeclarationCheck$MyException' which is a subclass of
    // 'java.lang.Throwable'.}}
  }

  public void foo13()
      throws MyRuntimeException, MyRuntimeException { // Noncompliant {{Remove the redundant
    // 'checks.RedundantThrowsDeclarationCheck$MyRuntimeException' thrown
    // exception declaration(s).}}
  }

  public void foo14()
      throws MyRuntimeException, Throwable { // Compliant - being explicit with the runtime
  }
...
abstract class ThrownCheckedExceptions extends MySuperClass {
  public ThrownCheckedExceptions(String s)
      throws MyException { // Noncompliant [[sc=51;ec=62;quickfixes=qf_all_throws]] {{Remove the
    // declaration of thrown exception 'checks.MyException', as it cannot be
    // thrown from constructor's body.}}
  ...
  void foo0() throws MyException { // Noncompliant {{Remove the declaration of thrown exception
    // 'checks.MyException', as it cannot be thrown from method's body.}}
    bar();
  }

  void foo3() throws MyException { // Noncompliant {{Remove the declaration of thrown exception
    // 'checks.MyException', as it cannot be thrown from method's body.}}
    new MyClass() {
  ...
  protected Object readResolve()
      throws java.io.ObjectStreamException { // Compliant - Serializable contract
    return null;
  }
  ...
  void foo14(java.io.File file)
      throws java.io.IOException { // Compliant - Closeable.close() throws IOException
    try (java.io.FileInputStream fis = new java.io.FileInputStream(file)) {
      // do something
    }
  }

  void foo15(java.io.File file)
      throws Exception { // Compliant - AutoCloseable.close() throws Exception
    try (AutoCloseable ac = getAutoCloseableWithoutExceptionPlease(file)) {
      // do something
    }
  }

  void foo16(java.io.File file)
      throws MyException { // Noncompliant {{Remove the declaration of thrown exception
    // 'checks.MyException', as it cannot be thrown from method's body.}}
  ...
  void foo17(java.io.File file)
      throws java.io.IOException { // Compliant MyCloseable inherits from Closeable
    try (MyCloseable mac = getMyCloseable(file)) {
      // do something
    }
  }

  void foo18(java.io.File file)
      throws IOException,
          ParseException { // Noncompliant  [[sc=53;ec=67;quickfixes=qf_last]] {{Remove the
    // declaration of thrown exception 'java.text.ParseException', as it
  ...
  void foo20(java.io.File file)
      throws
          ParseException { // Compliant - AutoCloseableParserInterface.close() throws ParseException
    try (AutoCloseableParserInterface mac = getAutoCloseableInterfaceWithParseException(file)) {
      // do something
    }
  }

  void foo21(java.io.File file)
      throws ParseException { // Compliant - AutoCloseableParserClass.close() throws ParseException
  ...
  abstract AutoCloseableParserInterface getAutoCloseableInterfaceWithParseException(
      java.io.File file);
  ...
  interface MyOtherInterface {
    ...
    default Object bar(Object o)
        throws MyException { // Compliant - default method are also defining a contract
      return o;
    }
...
abstract class NonThrownExceptionClass {
  ...
  static class NormalClass {
     ...
     */
    private void nonOverrideableMethod1()
        throws MyException { // Noncompliant {{Remove the declaration of thrown exception
      // 'checks.MyException', as it cannot be thrown from method's body.}}
      bar();
    }
     ...
     * @throws MyException proper javadoc description
     */
    static void nonOverrideableMethod2()
        throws MyException { // Noncompliant {{Remove the declaration of thrown exception
      // 'checks.MyException', as it cannot be thrown from method's body.}}
      qix();
    }
     ...
     * @throws MyException proper javadoc description
     */
    final void nonOverrideableMethod3()
        throws MyException { // Noncompliant {{Remove the declaration of thrown exception
      // 'checks.MyException', as it cannot be thrown from method's body.}}
      bar();
    }
     ...
     * @throws MyException proper javadoc description
     */
    void overrideableMethod1()
        throws MyException { // Compliant : can be overridden and has javadoc associated
      bar();
    }
     ...
     * @throws MyException proper javadoc description
     */
    protected void overrideableMethod2()
        throws MyException { // Compliant : can be overridden and has javadoc associated
      bar();
    }
     ...
     * @exception MyException proper javadoc description
     */
    public void overrideableMethod3()
        throws MyException { // Compliant : can be overridden and has javadoc associated
      bar();
    }
     ...
     */
    public void missingJavadocForException()
        throws MyException, java.io.IOException,
            MyException2 { // Noncompliant [[sc=66;ec=85;quickfixes=qf_middle]] {{Remove the
      // declaration of thrown exception 'java.io.IOException', as it cannot be
...
class RedundantThrowsDeclarationParent {
  ...
  public RedundantThrowsDeclarationParent(String a, String b)
      throws IllegalAccessException { // Compliant
    foo();
  }
...
class RedundantThrowsDeclarationChild extends RedundantThrowsDeclarationParent {
  ...
  public RedundantThrowsDeclarationChild(Integer a)
      throws IllegalAccessException { // Compliant, implicit call can throw IllegalAccessException
    // implicit call to parent constructor
    System.out.println("a:" + a);
  }

  public RedundantThrowsDeclarationChild(Long a)
      throws IllegalAccessException { // Compliant, equivalent to "Child(Integer a)"
    super();
    System.out.println("a:" + a);
  }
  ...
  public RedundantThrowsDeclarationChild(Integer a, Integer b)
      throws IllegalAccessException { // Compliant, call to Parent that calls foo, that thows
...
class RedundantThrowsDeclarationA {
  ...
  class Child1 extends Parent1 {
    public Child1(Long a) throws IllegalAccessException { // Noncompliant
      RedundantThrowsDeclarationA.this.super("a:" + a);
    }
  }
}
