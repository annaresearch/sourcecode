...
interface RedundantModifierInterface {
  ...
  static
  interface InnerInterface {} // Noncompliant [[sc=3;ec=9]] {{"static" is redundant in this
                              // context.}}

  public
  interface InnerInterface2 {} // Noncompliant [[sc=3;ec=9]] {{"public" is redundant in this
                               // context.}}
...
class RedundantModifierNonFinalClass {
  ...
  public static
  interface InnerInterface {} // Noncompliant {{"static" is redundant in this context.}}
...
enum RedundantModifierFoo {
  ...
  private RedundantModifierFoo(
      String s) {} // Noncompliant {{"private" is redundant in this context.}}
}
