...
class ReplaceGuavaWithJavaCheck {
  ReplaceGuavaWithJavaCheck(
      com.google.common.base.Predicate
          p) {} // Noncompliant [[sc=29;ec=61]] {{Use "java.util.function.Predicate" instead.}}

  ReplaceGuavaWithJavaCheck(
      com.google.common.base.Function
          f) {} // Noncompliant {{Use "java.util.function.Function" instead.}}

  ReplaceGuavaWithJavaCheck(
      com.google.common.base.Supplier
          s) {} // Noncompliant {{Use "java.util.function.Supplier" instead.}}

  ReplaceGuavaWithJavaCheck(
      com.google.common.base.Optional o) {} // Noncompliant {{Use "java.util.Optional" instead.}}
  ...
  void doX() {
    com.google.common.base.Predicate
        p; // Noncompliant {{Use "java.util.function.Predicate" instead.}}
    com.google.common.base.Function
        f; // Noncompliant {{Use "java.util.function.Function" instead.}}
    com.google.common.base.Supplier
        s; // Noncompliant {{Use "java.util.function.Supplier" instead.}}
  ...
  void doZ() {
    ...
    com.google.common.io.BaseEncoding
        .base64Url(); // Noncompliant {{Use "java.util.Base64" instead.}}

    com.google.common.base.Optional.fromJavaUtil(java.util.Optional.empty());
    com.google.common.base.Optional
        .absent(); // Noncompliant {{Use "java.util.Optional.empty" instead.}}
    com.google.common.base.Optional.of(
        new Object()); // Noncompliant {{Use "java.util.Optional.of" instead.}}
    com.google.common.base.Optional.fromNullable(
        null); // Noncompliant {{Use "java.util.Optional.ofNullable" instead.}}
  ...
  void tempDir() throws IOException {
    com.google.common.io.Files.createTempDir(); // Noncompliant [[sc=5;ec=47]] {{Use
    // "java.nio.file.Files.createTempDirectory" instead.}}
    Files.createTempDir(); // Noncompliant [[sc=5;ec=26]] {{Use
    // "java.nio.file.Files.createTempDirectory" instead.}}
