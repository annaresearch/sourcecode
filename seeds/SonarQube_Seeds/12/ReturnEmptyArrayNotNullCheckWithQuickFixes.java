...
class ReturnEmptyArrayNotNullCheckWithQuickFixes {
  ...
  Object[] array1() {
    ...
    return null; // Noncompliant [[sc=12;ec=16;quickfixes=array]] {{Return an empty array instead of
    // null.}}
  ...
  String[][] array2() {
    ...
    return null; // Noncompliant [[sc=12;ec=16;quickfixes=multi_dim_array]] {{Return an empty array
    // instead of null.}}
  ...
  List<String>[] array_generics() {
    ...
    return null; // Noncompliant [[sc=12;ec=16;quickfixes=array_generics]] {{Return an empty array
    // instead of null.}}
  ...
  List<Map<String[], Set<Object>>[]>[][] strange_array() {
    ...
    return null; // Noncompliant [[sc=12;ec=16;quickfixes=strange_array]] {{Return an empty array
    // instead of null.}}
  ...
  List<Object> list() {
    ...
    return null; // Noncompliant [[sc=12;ec=16;quickfixes=list]] {{Return an empty collection
    // instead of null.}}
  ...
  ArrayList<Object> arraylist() {
    ...
    return null; // Noncompliant [[sc=12;ec=16;quickfixes=arraylist]] {{Return an empty collection
    // instead of null.}}
  ...
  LinkedList<Object> linkedlist() {
    ...
    return null; // Noncompliant [[sc=12;ec=16;quickfixes=linkedlist]] {{Return an empty collection
    // instead of null.}}
  ...
  MyCustomList<Object> customList() {
    return null; // Noncompliant [[sc=12;ec=16;quickfixes=!]] {{Return an empty collection instead
    // of null.}}
  }

  Set<Object> set() {
    Set<Object> result = Collections.emptySet();
    return null; // Noncompliant [[sc=12;ec=16;quickfixes=set]] {{Return an empty collection instead
    // of null.}}
  ...
  HashSet<Object> hashset() {
    ...
    return null; // Noncompliant [[sc=12;ec=16;quickfixes=hashset]] {{Return an empty collection
    // instead of null.}}
  ...
  TreeSet<Object> treeset() {
    ...
    return null; // Noncompliant [[sc=12;ec=16;quickfixes=treeset]] {{Return an empty collection
    // instead of null.}}
  ...
  SortedSet<Object> sortedset() {
    ...
    return null; // Noncompliant [[sc=12;ec=16;quickfixes=sortedset]] {{Return an empty collection
    // instead of null.}}
  ...
  NavigableSet<Object> navigableset() {
    ...
    return null; // Noncompliant [[sc=12;ec=16;quickfixes=navigableset]] {{Return an empty
  ...
  Map<Object, Object> map() {
    ...
    return null; // Noncompliant [[sc=12;ec=16;quickfixes=map]] {{Return an empty map instead of
    // null.}}
  ...
  HashMap<Object, Object> hashmap() {
    ...
    return null; // Noncompliant [[sc=12;ec=16;quickfixes=hashmap]] {{Return an empty map instead of
    // null.}}
  ...
  SortedMap<Object, Object> sortedmap() {
    ...
    return null; // Noncompliant [[sc=12;ec=16;quickfixes=sortedmap]] {{Return an empty map instead
    // of null.}}
  ...
  NavigableMap<Object, Object> navigableMap() {
    ...
    return null; // Noncompliant [[sc=12;ec=16;quickfixes=navigableMap]] {{Return an empty map
    // instead of null.}}
  ...
  Collection<Object> collection() {
    ...
    return null; // Noncompliant [[sc=12;ec=16;quickfixes=collection]] {{Return an empty collection
    // instead of null.}}
