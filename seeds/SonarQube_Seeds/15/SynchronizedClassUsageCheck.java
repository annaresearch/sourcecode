...
public class SynchronizedClassUsageCheck {
  ...
  class A implements IA {
    ...
    Map a3 = new Hashtable(); // Noncompliant {{Replace the synchronized class "Hashtable" by an
    // unsynchronized one such as "HashMap".}}
    Hashtable a4 =
    ...
    A(Vector v) { // Noncompliant {{Replace the synchronized class "Vector" by an unsynchronized one
    ...
    public void f(
        Vector a) { // Noncompliant [[sc=19;ec=25]] {{Replace the synchronized class "Vector" by an
      // unsynchronized one such as "ArrayList" or "LinkedList".}}
    }
  ...
  enum AEnum implements AInterface {
    ...
    Vector b() { // Noncompliant {{Replace the synchronized class "Vector" by an unsynchronized one
      // such as "ArrayList" or "LinkedList".}}
      return null;
    }
