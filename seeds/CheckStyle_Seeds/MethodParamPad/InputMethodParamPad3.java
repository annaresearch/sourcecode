...
public class InputMethodParamPad3 {
  ...
  public InputMethodParamPad3(double aParam) // violation ''(' should be on the previous line'
      {
    super(); // violation ''(' should be on the previous line'
  }
  ...
  public void method(double aParam) // violation ''(' should be on the previous line'
      {
    // invoke constructor
    InputMethodParamPad pad =
        new InputMethodParamPad(); // violation ''(' is not preceded with whitespace'
    pad = new InputMethodParamPad();
    pad = new InputMethodParamPad(); // violation ''(' should be on the previous line'

    // call method
    method(); // violation ''(' is not preceded with whitespace'
    method();
    method(); // violation ''(' should be on the previous line'
  }
  ...
  public void dottedCalls() // violation ''(' is not preceded with whitespace'
    ...
    this.method();
    this.method(); // violation ''(' should be on the previous line'

    InputMethodParamPad p =
        new InputMethodParamPad(); // violation ''(' is not preceded with whitespace'
    p.method(); // violation ''(' is not preceded with whitespace'
    p.method();
    p.method(); // violation ''(' should be on the previous line'

    java.lang.Integer.parseInt("0"); // violation ''(' is not preceded with whitespace'
    java.lang.Integer.parseInt("0");
    java.lang.Integer.parseInt("0"); // violation ''(' should be on the previous line'
  }
  ...
  enum TestEnum {
    ...
    SECOND() // violation ''(' should be on the previous line'
    {}
  }
}
