...
public class InputMissingJavadocMethodPublicOnly {
  ...
  /**
   * A param tag should not be required here when relaxed about Javadoc. Writing a little
   * documentation should not be worse than not writing any documentation at all.
   */
