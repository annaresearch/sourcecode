...
public class InputArrayTrailingCommaAlwaysDemandTrailingComma {
  ...
  public void test3() {
    int[] a = new int[] {0}; // violation 'Array should contain trailing comma.'
    int[] b = new int[] {0, 1}; // violation 'Array should contain trailing comma.'
    int[] c =
        new int[] {
          0, 1, 2, 3 // violation 'Array should contain trailing comma.'
        };
    int[] d =
        new int[] {
