...
public class InputMultipleVariableDeclarations {
  ...
  int i1;
  int j1; // violation 'Only one variable definition per line allowed.'

  void method1() {
    String str, str1; // violation 'Each variable declaration must be in its own statement.'
    Object obj;
    Object obj1; // violation 'Only one variable definition per line allowed.'
  }
  // second definition is wrapped
  // line of VARIABLE_DEF is not the same as first line of the definition
  java.lang.String string;
  String // violation 'Only one variable definition per line allowed.'
      strings[];
