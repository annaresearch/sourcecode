...
public class InputJavadocTagContinuationIndentationDescription {
   ...
   *
   * @param s Description 1. // violation Description 2. // violation Description 3. // violation
  ...
  /**
   * @param s Description with missing space. // violation
   * @param s2 ****Description with multiple asterisk and missing space // violation ****
