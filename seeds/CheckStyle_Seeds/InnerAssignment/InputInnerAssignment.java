...
public class InputInnerAssignment {
  ...
  public static void demoNoBrace() {
    ...
    while (o != null) t = o = o.getParent(); // violation
  }
  ...
  void method() throws IOException {
    ...
    do {} while (!((line = file.read()) != null));
    do {} while ((line = file.read()) != null && line < 3);
    do {} while ((line = file.read()) != null && line < 3 && line > 5);
    do {} while ((line = file.read()) != null || line < 3);
    do {} while ((line = file.read()) != null || line < 3 || line > 5);
    do {} while ((line = file.read()) != null & line < 3);
    do {} while ((line = file.read()) != null & line < 3 & line > 5);
    do {} while ((line = file.read()) != null | line < 3);
    do {} while ((line = file.read()) != null | line < 3 | line > 5);
    do {} while (line < 3 && (line = file.read()) != null);
    do {} while (line < 3 || (line = file.read()) != null);
    do {} while (line < 3 & (line = file.read()) != null);
    do {} while (line < 3 | (line = file.read()) != null);
