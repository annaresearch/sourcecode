...
public class InputMethodNameExtra // ok
 {
  public void doit() {
    ...
    createNameHistoryDetails(
        historyDetails,
        previousNameService,
        entityId,
        new More.ViewChangeHistoryBaseAction.ChangeHistoryDisplayName(agencyName) {
          String getDisplayName() { // comment
            return getPreviousName();
          }
        });
  }

  private void createNameHistoryDetails(
      Object historyDetails,
      Object previousNameService,
      Object entityId,
      More.ViewChangeHistoryBaseAction.ChangeHistoryDisplayName changeHistoryDisplayName) {}
  ...
  private void createNameHistoryDetails(
      ...
      Object previousNameService,
      Object entityId,
      ChangeHistoryDisplayName changeHistoryDisplayName) {}
