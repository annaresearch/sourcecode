...
public class InputHiddenFieldLambdas {
  /** Example 1: lambda parameter 'value' on line 16 hides a field 'value' on line 14. */
  ...
  /**
   * Example 2: lambda parameter 'name' on line 27 does not hide a field 'name' on line 25, because
  ...
  /**
   * Example 3: lambda parameter 'brand' on line 38 (which type is omitted) does not hide a field
   * 'brand' on line 36, because field 'brand' can not be referenced from a static context.
   */
  ...
  /**
   * Example 4: lambda parameter 'languageCode' on line 48 hides a field 'languageCode' on line 46.
   */
  ...
  /** Example 5: lambda parameter 'number' on line 57 hides a field 'number' on line 55. */
  int number = 1;
  ...
  /** Example 6: lambda parameter 'id' on line 70 hides a field 'id' on line 68. */
  static long id = 1;
  ...
  /**
   * Example 7: lambda parameter 'age' on line 84 does not hide a field 'age' on line 82, because
   * field 'age' can not be referenced from a static context.
   */
  int age = 21;
  ...
  /** Example 8: lambda parameter 'note' on line 98 hides a field 'note' on line 95. */
  ...
  /**
   * Example 9: lambda parameter 'letter' on line 109 does not hide a field 'letter' on line 106,
   * because field 'letter' can not be referenced from a static context.
   */
...

  {
    Function<String, Integer> m =
        (String stringValue, Integer intValue) -> { // 2 violations
  ...
  {
    Function<Integer, Double> a =
        (Integer integerValue, Double doubleValue) -> { // violation
  ...
  {
    Function<String, String> stringConcat =
        (firstString, secondString) -> { // 2 violations
  ...
  /** Example 15: lambda stored in field (with typed parameter) hides other field */
  Object someObject = new Object();

  FunctionWithOneParameter objectToString =
      (Object someObject) -> { // violation
        return someObject.toString();
      };

  /** Example 16: lambda stored in field (with untyped parameter) hides other field */
  FunctionWithOneParameter otherObjectToString =
      someObject -> { // violation
        return someObject.toString();
      };
