...
public interface InputJavadocContentLocationTrailingSpace {
  ...
  /**
   * *************************************** There is a spaces, then leading asterisks, then spaces
   * ^^ in the first line // OK
   */
  ...
  /**
   * * *** There is a space, then a leading asterisk, then a space, then asterisks in the first line
   * // OK The generated javadoc will be "*** There is a space ..."
   */
  ...
  /**
   * * *** There is a space, then a leading asterisk, then a space again, then asterisks, then third
   * space in the first line // OK The generated javadoc will be "*** There is a space ..."
   */
