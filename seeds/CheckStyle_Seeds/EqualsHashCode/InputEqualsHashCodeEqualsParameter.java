...
public class InputEqualsHashCodeEqualsParameter {
  ...
  public abstract static class TestClass11 { // ok
    public abstract int hashCode();

    public abstract boolean equals(Object o);
  }

  public abstract static class TestClass12 { // violation, no `equals` implementation
    public int hashCode() { // violation 'without .* of 'equals()'.'
      return 1;
    }
  ...
  public abstract static class TestClass13 { // violation, no `hashCode` implementation
    public abstract int hashCode();
