...
class InputJavadocParagraphIncorrect {
  ...
  class InnerInputJavadocParagraphIncorrect {
     ...
     *
     * <p>// violation 'tag should be placed immediately before the first word' /^WARN/
     *
     * <p>// 2 violations /^WARN/ Some Javadoc.
     *
     * <p>// 2 violations
     *
     * @see <a
  ...
  InnerInputJavadocParagraphIncorrect anon =
      new InnerInputJavadocParagraphIncorrect() {
         ...
         *     href="http://www.gwtproject.org/doc/latest/DevGuideOrganizingProjects.html#DevGuideModules">
         *     Documentation about
         *     <p>GWT emulated source</a> // 2 violations
         */
        boolean emulated() {
          return false;
        }
         ...
         * Double newline.
         *
         * <p>Some Javadoc. //DOUBLE WARN AT TWO PREVIOUS LINES
         */
