 ...
 * OneStatementPerLineCheck</code>-checkstyle enhancement.
 *
...
public class InputOneStatementPerLineSingleLine {
  /**
   * Dummy innerclass to test the behaviour in the case of a smalltalk-style statements (<code>
   * myObject.firstMethod().secondMethod().thirdMethod()</code>). For this programming style each
   * method must return the object itself <code>this</code>.
   */
  ...
  /**
   * The StringBuffer is a Java-API-class that permits smalltalk-style concatenation on the <code>
   * append</code>-method.
   */
  ...
  /**
   * This method contains two increment statements and two object creation statements on the same
   * line.
   */
  private void foo() {
    ...
    Object obj2 = new Object(); // violation
  }

  /** This method contains break, while-loop and for-loop statements. */
  private void foo3() {
    do {
      one++;
      if (two > 4) {
