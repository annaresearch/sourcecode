...
public class InputLeftCurlyWithEmoji {
  ...
  private void method2() { // ok
    ...
    try { // violation ''{' at column 9 should be on the previous line'
      if (x.equals("🎄🤣")) { // violation ''{' at column 13 should be on the previous line'
...
enum InputLeftCurlyMethodEnumWithEmoji { // violation ''{' at column 5 should be on the previous
  // line'
  CONSTANT1("🧐🧐dsds🧐") {
    void method1() {} // ok
