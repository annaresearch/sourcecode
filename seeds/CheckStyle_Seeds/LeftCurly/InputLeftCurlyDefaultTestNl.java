...
public class InputLeftCurlyDefaultTestNl { // ok
  ...
  private class MyClass1 { // violation ''{' at column 14 should be on a new line'
  }
  ...
  @Deprecated
  public class MyClass3 { // violation ''{' at column 20 should be on a new line'
  }
  ...
  public class MyClass4 { // violation ''{' at column 27 should be on a new line'
    void method() { // violation ''{' at column 23 should be on a new line'
      while (true) {
        /*foo*/
      } // violation ''{' at column 25 should be on a new line'
    }
  }
}
