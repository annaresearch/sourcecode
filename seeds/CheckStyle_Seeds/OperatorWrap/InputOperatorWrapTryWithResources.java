...
public class InputOperatorWrapTryWithResources implements AutoCloseable {
  public static void main(String[] args) throws Exception {
    ...
    try ((args.length > 0 ? v : new InputOperatorWrapTryWithResources())
        .finalWrapper
        .finalField) { // ok
    }
    ...
    try (i1;
        InputOperatorWrapTryWithResources i2 = new InputOperatorWrapTryWithResources()) {}

    InputOperatorWrapTryWithResources m1 = new InputOperatorWrapTryWithResources();
    try (m1;
        InputOperatorWrapTryWithResources m2 = m1; // ok
        InputOperatorWrapTryWithResources m3 = m2; ) {}
  }

  static final FinalWrapper finalWrapper = new FinalWrapper();
  ...
  static class FinalWrapper {
    public final AutoCloseable finalField =
        new AutoCloseable() {
          @Override
