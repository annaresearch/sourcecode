...
public class InputJavadocStyle9 // ok
 {
  ...
  /**
   * We don't want {@link com.puppycrawl.tools.checkstyle.checks.JavadocStyleCheck} tags to stop the
   * scan for the end of sentence.
   *
   * @see Something
   */
  ...
  /** // violation This should fail even.though.there are embedded periods */
  ...
  /** // violation Package protected check <b>should fail // violation */
  void method7() {}

  /** Public check should fail</code> should fail < */
  ...
  /**
   * Real men don't use XHTML. <br>
   * <hr/> < br/> <img src="schattenparker.jpg"/></img> // violation
   */
   ...
   *
   * <p>Sometimes a p tag is closed.
   *
   * <p>Sometimes it's not.
   *
   * <p><span style="font-family:'Times New Roman',Times,serif;font-size:200%"> Attributes can
   * contain spaces and nested quotes. </span> <img src="slashesCanOccurWithin/attributes.jpg"/>
   * <img src="slashesCanOccurWithin/attributes.jpg">
   * <!-- comments <div> should not be checked. -->
   */
  private void method11() {} // ok

  /** Tags for two lines. <a href="some_link" >Link Text</a> */
  ...
  /**
   * // violation Empty line between javadoc and method declaration cause wrong line number for
   * reporting error (bug 841942)
   */
  ...
  /** Checks if the specified IClass needs to be annotated with the @Type annotation. */
  public void foo_1291847_1() {} // ok

  /** Returns the string containing the properties of <code>@Type</code> annotation. */
   ...
   *
   * <p>HTML no good tag <string>Tests</string>
   */
  ...
  /** <b>Note:<b> it's unterminated tag. // violation */
