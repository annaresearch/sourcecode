...
public class InputJavadocStyle7 {
  ...
  /** // violation Protected check <b>should fail // violation */
  protected void method6() {}

  /** // violation Package protected check <b>should fail // violation */
  void method7() {}

  /** // violation Public check should fail</code> // violation should fail < */
  // violation above
  public void method8() {}
   ...
   * <hr/> < br/> <img src="schattenparker.jpg"/></img>
   */
  ...
  /**
   * Empty line between javadoc and method declaration cause wrong line number for reporting error
   * (bug 841942)
   */
  ...
  public enum Test {
    /** // violation Value 1 without a period */
    value1,
   ...
   *
   * <p>HTML no good tag <string>Tests</string> // violation
   */
